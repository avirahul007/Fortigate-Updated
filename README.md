...
2. Download this collection from galaxy: `ansible-galaxy collection install fortinet.fortios:2.1.0`
...
|6.0.0|2.0.2 `latest`|2021/5/14|`ansible-galaxy collection install fortinet.fortios:2.0.2`|
