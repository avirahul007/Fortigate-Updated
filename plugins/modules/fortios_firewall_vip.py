...
def filter_firewall_vip_data(json):
    option_list = ['arp_reply', 'color', 'comment',
                   ...
                   'http_redirect', 'https_cookie_secure', 'id',
                   'ldb_method', 'mapped_addr', 'mappedip',
                   'mappedport', 'max_embryonic_connections', 'monitor',
                   'name', 'nat_source_vip', 'outlook_web_access',
                   'persistence', 'portforward', 'portmapping_type',
                   'protocol', 'realservers', 'server_type',
                   'service', 'src_filter', 'srcintf_filter',
                   'ssl_algorithm', 'ssl_certificate', 'ssl_cipher_suites',
                   'ssl_client_fallback', 'ssl_client_rekey_count', 'ssl_client_renegotiation',
                   'ssl_client_session_state_max', 'ssl_client_session_state_timeout', 'ssl_client_session_state_type',
                   'ssl_dh_bits', 'ssl_hpkp', 'ssl_hpkp_age',
                   'ssl_hpkp_backup', 'ssl_hpkp_include_subdomains', 'ssl_hpkp_primary',
                   'ssl_hpkp_report_uri', 'ssl_hsts', 'ssl_hsts_age',
                   'ssl_hsts_include_subdomains', 'ssl_http_location_conversion', 'ssl_http_match_host',
                   'ssl_max_version', 'ssl_min_version', 'ssl_mode',
                   'ssl_pfs', 'ssl_send_empty_frags', 'ssl_server_algorithm',
                   'ssl_server_cipher_suites', 'ssl_server_max_version', 'ssl_server_min_version',
                   'ssl_server_session_state_max', 'ssl_server_session_state_timeout', 'ssl_server_session_state_type',
                   'status', 'type', 'uuid',
...
def flatten_multilists_attributes(data):
    multilist_attrs = [[u'ssl_cipher_suites', u'versions'], [u'ssl_server_cipher_suites', u'versions']]
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["firewall_vip"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "firewall_vip")
