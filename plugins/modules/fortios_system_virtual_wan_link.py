...
def flatten_multilists_attributes(data):
    multilist_attrs = [[u'health_check', u'sla', u'link_cost_factor']]
...
def system_virtual_wan_link(data, fos):
    ...
    system_virtual_wan_link_data = flatten_multilists_attributes(system_virtual_wan_link_data)
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["system_virtual_wan_link"]['options'][attribute_name] = module_spec['options'][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["system_virtual_wan_link"]['options'][attribute_name]['required'] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "system_virtual_wan_link")
