...
def filter_router_bgp_data(json):
    option_list = ['additional_path', 'additional_path_select', 'additional_path_select6',
                   ...
                   'log_neighbour_changes', 'multipath_recursive_distance', 'neighbor',
                   'neighbor_group', 'neighbor_range', 'neighbor_range6',
                   'network', 'network_import_check', 'network6',
                   'recursive_next_hop', 'redistribute', 'redistribute6',
...
def flatten_multilists_attributes(data):
    multilist_attrs = [[u'neighbor_group', u'attribute_unchanged6'], [u'neighbor_group', u'attribute_unchanged'], [u'neighbor', u'attribute_unchanged6'],
                       [u'neighbor', u'attribute_unchanged']]
