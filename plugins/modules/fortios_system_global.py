...
def filter_system_global_data(json):
    option_list = ['admin_concurrent', 'admin_console_timeout', 'admin_forticloud_sso_login',
                   'admin_hsts_max_age', 'admin_https_pki_required', 'admin_https_redirect',
                   ...
                   'auto_auth_extension_device', 'autorun_log_fsck', 'av_affinity',
                   ...
                   'check_reset_range', 'cli_audit_log', 'cloud_communication',
                   'clt_cert_req', 'compliance_check', 'compliance_check_time',
                   'cpu_use_threshold', 'csr_ca_attribute', 'daily_restart',
                   'default_service_source_port', 'device_identification_active_scan_delay', 'device_idle_timeout',
                   'dh_params', 'dnsproxy_worker_count', 'dst',
                   'edit_vdom_prompt', 'endpoint_control_fds_access', 'endpoint_control_portal_port',
                   'failtime', 'faz_disk_buffer_size', 'fds_statistics',
                   'fds_statistics_period', 'fec_port', 'fgd_alert_subscription',
                   'fortiextender', 'fortiextender_data_port', 'fortiextender_vlan_mode',
                   'fortiipam_integration', 'fortiservice_port', 'fortitoken_cloud',
                   'gui_allow_default_hostname', 'gui_certificates', 'gui_custom_language',
                   'gui_date_format', 'gui_date_time_source', 'gui_device_latitude',
                   'gui_device_longitude', 'gui_display_hostname', 'gui_firmware_upgrade_warning',
                   'gui_forticare_registration_setup_warning', 'gui_fortigate_cloud_sandbox', 'gui_fortisandbox_cloud',
                   'gui_ipv6', 'gui_lines_per_page', 'gui_local_out',
                   'gui_replacement_message_groups', 'gui_rest_api_cache', 'gui_theme',
                   'gui_wireless_opensecurity', 'honor_df', 'hostname',
                   'igmp_state_limit', 'interval', 'ip_src_port_range',
                   'ips_affinity', 'ipsec_asic_offload', 'ipsec_ha_seqjump_rate',
                   'ipsec_hmac_offload', 'ipsec_soft_dec_async', 'ipv6_accept_dad',
                   'ipv6_allow_anycast_probe', 'ipv6_allow_traffic_redirect', 'irq_time_accounting',
                   'language', 'ldapconntimeout', 'lldp_reception',
                   'lldp_transmission', 'log_ssl_connection', 'log_uuid',
                   'log_uuid_address', 'log_uuid_policy', 'login_timestamp',
                   'long_vdom_name', 'management_ip', 'management_port',
                   ...
                   'per_user_bal', 'per_user_bwl', 'policy_auth_concurrent',
                   ...
                   'proxy_cipher_hardware_acceleration', 'proxy_hardware_acceleration', 'proxy_kxp_hardware_acceleration',
                   'proxy_re_authentication_mode', 'proxy_resource_mode', 'proxy_worker_count',
                   ...
                   'snat_route_change', 'special_file_23_support', 'split_port',
                   'ssd_trim_date', 'ssd_trim_freq', 'ssd_trim_hour',
                   'ssd_trim_min', 'ssd_trim_weekday', 'ssh_cbc_cipher',
                   'ssh_hmac_md5', 'ssh_kex_sha1', 'ssh_mac_weak',
                   'ssl_min_proto_version', 'ssl_static_key_ciphers', 'sslvpn_cipher_hardware_acceleration',
                   'sslvpn_ems_sn_check', 'sslvpn_kxp_hardware_acceleration', 'sslvpn_max_worker_count',
                   ...
                   'tcp_rst_timer', 'tcp_timewait_timer', 'tftp',
                   ...
                   'user_device_store_max_devices', 'user_device_store_max_users', 'user_server_cert',
                   'vdom_admin', 'vdom_mode', 'vip_arp_range',
