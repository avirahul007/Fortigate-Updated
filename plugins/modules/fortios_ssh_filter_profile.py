...
def filter_ssh_filter_profile_data(json):
    option_list = ['block', 'default_command_log', 'file_filter',
                   'log', 'name', 'shell_commands']
    dictionary = {}
...
def flatten_multilists_attributes(data):
    multilist_attrs = [[u'file_filter', u'entries', u'protocol'], [u'block'], [u'log']]
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["ssh_filter_profile"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "ssh_filter_profile")

        is_error, has_changed, result = fortios_ssh_filter(module.params, fos, module.check_mode)
