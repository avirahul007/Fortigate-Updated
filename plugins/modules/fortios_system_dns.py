...
def filter_system_dns_data(json):
    option_list = ['cache_notfound_responses', 'dns_cache_limit', 'dns_cache_ttl',
                   'dns_over_tls', 'domain', 'interface',
                   'interface_select_method', 'ip6_primary', 'ip6_secondary',
                   'primary', 'protocol', 'retry',
                   'secondary', 'server_hostname', 'source_ip',
                   'ssl_certificate', 'timeout']
    dictionary = {}
