...
def filter_system_vdom_dns_data(json):
    option_list = ['dns_over_tls', 'interface', 'interface_select_method',
                   'ip6_primary', 'ip6_secondary', 'primary',
                   'protocol', 'secondary', 'server_hostname',
                   'source_ip', 'ssl_certificate', 'vdom_dns']
    dictionary = {}
