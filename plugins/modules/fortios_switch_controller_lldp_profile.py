...
def flatten_multilists_attributes(data):
    multilist_attrs = [[u'med_tlvs'], [u'802.3_tlvs'], [u'802.1_tlvs']]
...
def switch_controller_lldp_profile(data, fos, check_mode=False):
    ...
    switch_controller_lldp_profile_data = flatten_multilists_attributes(switch_controller_lldp_profile_data)
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["switch_controller_lldp_profile"]['options'][attribute_name] = module_spec['options'][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["switch_controller_lldp_profile"]['options'][attribute_name]['required'] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "switch_controller_lldp_profile")
