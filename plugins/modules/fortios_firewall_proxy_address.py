...
def firewall_proxy_address(data, fos, check_mode=False):
    ...
    firewall_proxy_address_data = flatten_multilists_attributes(firewall_proxy_address_data)
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["firewall_proxy_address"]['options'][attribute_name] = module_spec['options'][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["firewall_proxy_address"]['options'][attribute_name]['required'] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "firewall_proxy_address")
