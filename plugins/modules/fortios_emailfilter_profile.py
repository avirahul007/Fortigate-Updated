...
def filter_emailfilter_profile_data(json):
    option_list = ['comment', 'external', 'feature_set',
                   'file_filter', 'gmail', 'imap',
                   'mapi', 'msn_hotmail', 'name',
                   'options', 'other_webmails', 'pop3',
                   'replacemsg_group', 'smtp', 'spam_bal_table',
...
def flatten_multilists_attributes(data):
    multilist_attrs = [[u'smtp', u'tag_type'], [u'pop3', u'tag_type'], [u'imap', u'tag_type'], [u'file_filter', u'entries', u'protocol'], [u'options']]
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["emailfilter_profile"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "emailfilter_profile")

        is_error, has_changed, result = fortios_emailfilter(module.params, fos, module.check_mode)
