...
def filter_web_proxy_global_data(json):
    option_list = ['fast_policy_match', 'forward_proxy_auth', 'forward_server_affinity_timeout',
                   ...
                   'max_waf_body_cache_length', 'proxy_fqdn', 'src_affinity_exempt_addr',
                   'src_affinity_exempt_addr6', 'ssl_ca_cert', 'ssl_cert',
                   'strict_web_check', 'tunnel_non_http', 'unknown_http_version',
                   'webproxy_profile']
    dictionary = {}
...
def flatten_multilists_attributes(data):
    multilist_attrs = [[u'learn_client_ip_from_header']]
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["web_proxy_global"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "web_proxy_global")
