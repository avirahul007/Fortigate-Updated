...
def filter_user_ldap_data(json):
    option_list = ['account_key_filter', 'account_key_processing', 'antiphish',
                   'ca_cert', 'cnid', 'dn',
                   'group_filter', 'group_member_check', 'group_object_filter',
                   'group_search_base', 'interface', 'interface_select_method',
                   'member_attr', 'name', 'obtain_user_info',
                   'password', 'password_attr', 'password_expiry_warning',
                   'password_renewal', 'port', 'search_type',
                   'secondary_server', 'secure', 'server',
                   'server_identity_check', 'source_ip', 'source_port',
                   'ssl_min_proto_version', 'tertiary_server', 'two_factor',
                   'two_factor_authentication', 'two_factor_notification', 'type',
                   'user_info_exchange_server', 'username']
    dictionary = {}
