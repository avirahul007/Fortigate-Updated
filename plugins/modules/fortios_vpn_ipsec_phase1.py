...
def filter_vpn_ipsec_phase1_data(json):
    option_list = ['acct_verify', 'add_gw_route', 'add_route',
                   ...
                   'comments', 'dhcp_ra_giaddr', 'dhcp6_ra_linkaddr',
                   'dhgrp', 'digital_signature_auth', 'distance',
                   'dns_mode', 'domain', 'dpd',
                   'dpd_retrycount', 'dpd_retryinterval', 'eap',
                   'eap_exclude_peergrp', 'eap_identity', 'enforce_unique_id',
                   'esn', 'fec_base', 'fec_codec',
                   'fec_egress', 'fec_ingress', 'fec_receive_timeout',
                   'fec_redundant', 'fec_send_timeout', 'forticlient_enforcement',
                   'fragmentation', 'fragmentation_mtu', 'group_authentication',
                   'group_authentication_secret', 'ha_sync_esp_seqno', 'idle_timeout',
                   'idle_timeoutinterval', 'ike_version', 'include_local_lan',
                   'interface', 'ipv4_dns_server1', 'ipv4_dns_server2',
                   'ipv4_dns_server3', 'ipv4_end_ip', 'ipv4_exclude_range',
                   'ipv4_name', 'ipv4_netmask', 'ipv4_split_exclude',
                   'ipv4_split_include', 'ipv4_start_ip', 'ipv4_wins_server1',
                   'ipv4_wins_server2', 'ipv6_dns_server1', 'ipv6_dns_server2',
                   'ipv6_dns_server3', 'ipv6_end_ip', 'ipv6_exclude_range',
                   'ipv6_name', 'ipv6_prefix', 'ipv6_split_exclude',
                   'ipv6_split_include', 'ipv6_start_ip', 'keepalive',
                   'keylife', 'local_gw', 'localid',
                   'localid_type', 'loopback_asymroute', 'mesh_selector_type',
                   'mode', 'mode_cfg', 'name',
                   'nattraversal', 'negotiate_timeout', 'network_id',
                   'network_overlay', 'npu_offload', 'peer',
...
def flatten_multilists_attributes(data):
    multilist_attrs = [[u'signature_hash_alg'], [u'dhgrp'], [u'proposal']]
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["vpn_ipsec_phase1"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "vpn_ipsec_phase1")
