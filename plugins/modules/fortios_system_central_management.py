...
def filter_system_central_management_data(json):
    option_list = ['allow_monitor', 'allow_push_configuration', 'allow_push_firmware',
                   'allow_remote_firmware_upgrade', 'ca_cert', 'enc_algorithm',
                   'fmg', 'fmg_source_ip', 'fmg_source_ip6',
                   'fmg_update_port', 'include_default_servers', 'interface',
                   'interface_select_method', 'local_cert', 'mode',
                   'schedule_config_restore', 'schedule_script_restore', 'serial_number',
                   'server_list', 'type', 'vdom']
    dictionary = {}
...
def flatten_multilists_attributes(data):
    multilist_attrs = [[u'server_list', u'server_type']]
