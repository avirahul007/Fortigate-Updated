...
def filter_system_settings_data(json):
    option_list = ['allow_linkdown_path', 'allow_subnet_overlap', 'application_bandwidth_tracking',
                   ...
                   'ngfw_mode', 'opmode', 'prp_trailer_action',
                   'sccp_port', 'sctp_session_without_init', 'ses_denied_traffic',
                   'sip_expectation', 'sip_helper', 'sip_nat_trace',
...
def flatten_multilists_attributes(data):
    multilist_attrs = [[u'vpn_stats_log']]
