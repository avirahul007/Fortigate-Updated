...
def filter_system_link_monitor_data(json):
    option_list = ['addr_mode', 'class_id', 'diffservcode',
                   'failtime', 'gateway_ip', 'gateway_ip6',
                   'ha_priority', 'http_agent', 'http_get',
                   'http_match', 'interval', 'name',
                   'packet_size', 'password', 'port',
                   'probe_count', 'probe_timeout', 'protocol',
                   'recoverytime', 'route', 'security_mode',
                   'server', 'service_detection', 'source_ip',
