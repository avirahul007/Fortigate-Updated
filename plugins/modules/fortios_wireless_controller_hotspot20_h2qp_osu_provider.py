...
def wireless_controller_hotspot20_h2qp_osu_provider(data, fos, check_mode=False):
    ...
    wireless_controller_hotspot20_h2qp_osu_provider_data = flatten_multilists_attributes(wireless_controller_hotspot20_h2qp_osu_provider_data)
...
def fortios_wireless_controller_hotspot20(data, fos, check_mode):
    ...
    if data['wireless_controller_hotspot20_h2qp_osu_provider']:
        ...
        fos._module.fail_json(msg='missing task body: %s' % ('wireless_controller_hotspot20_h2qp_osu_provider'))
    if check_mode:
        return resp
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["wireless_controller_hotspot20_h2qp_osu_provider"]['options'][attribute_name] = module_spec['options'][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["wireless_controller_hotspot20_h2qp_osu_provider"]['options'][attribute_name]['required'] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "wireless_controller_hotspot20_h2qp_osu_provider")
