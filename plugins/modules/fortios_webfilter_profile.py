        ...
        suboptions:
            antiphish:
                ...
                suboptions:
                    ...
                    check_username_only:
                        description:
                            - Enable/disable acting only on valid username credentials. Action will be taken for valid usernames regardless of password
                               validity.
                        type: str
                        choices:
                            - enable
...
def filter_webfilter_profile_data(json):
    option_list = ['antiphish', 'comment', 'extended_log',
                   ...
                   'url_extraction', 'web', 'web_antiphishing_log',
                   'web_content_log', 'web_extended_all_action_log', 'web_filter_activex_log',
                   'web_filter_applet_log', 'web_filter_command_block_log', 'web_filter_cookie_log',
                   'web_filter_cookie_removal_log', 'web_filter_js_log', 'web_filter_jscript_log',
                   'web_filter_referer_log', 'web_filter_unknown_log', 'web_filter_vbs_log',
                   'web_ftgd_err_log', 'web_ftgd_quota_usage', 'web_invalid_domain_log',
                   'web_url_log', 'wisp', 'wisp_algorithm',
                   'wisp_servers', 'youtube_channel_filter', 'youtube_channel_status']
    dictionary = {}
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["webfilter_profile"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "webfilter_profile")

        is_error, has_changed, result = fortios_webfilter(module.params, fos, module.check_mode)
