...
def filter_switch_controller_global_data(json):
    option_list = ['allow_multiple_interfaces', 'bounce_quarantined_link', 'custom_command',
                   'default_virtual_switch_vlan', 'disable_discovery', 'fips_enforce',
                   'https_image_push', 'log_mac_limit_violations', 'mac_aging_interval',
                   'mac_event_logging', 'mac_retention_period', 'mac_violation_timer',
                   'quarantine_mode', 'sn_dns_resolution', 'update_user_device',
                   'vlan_all_mode', 'vlan_optimization']
    dictionary = {}
...
def flatten_multilists_attributes(data):
    multilist_attrs = [[u'update_user_device']]
