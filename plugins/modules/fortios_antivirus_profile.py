...
def filter_antivirus_profile_data(json):
    option_list = ['analytics_accept_filetype', 'analytics_bl_filetype', 'analytics_db',
                   ...
                   'external_blocklist_enable_all', 'feature_set', 'ftgd_analytics',
                   'ftp', 'http', 'imap',
                   'inspection_mode', 'mapi', 'mobile_malware_db',
                   'nac_quar', 'name', 'nntp',
                   'outbreak_prevention', 'outbreak_prevention_archive_scan', 'pop3',
                   'replacemsg_group', 'scan_mode', 'smb',
                   'smtp', 'ssh']
    dictionary = {}
