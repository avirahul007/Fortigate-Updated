...
def filter_firewall_gtp_data(json):
    option_list = ['addr_notify', 'apn', 'apn_filter',
                   'authorized_ggsns', 'authorized_ggsns6', 'authorized_sgsns',
                   'authorized_sgsns6', 'comment', 'context_id',
                   'control_plane_message_rate_limit', 'default_apn_action', 'default_imsi_action',
                   'default_ip_action', 'default_noip_action', 'default_policy_action',
                   'denied_log', 'echo_request_interval', 'extension_log',
                   'forwarded_log', 'global_tunnel_limit', 'gtp_in_gtp',
                   'gtpu_denied_log', 'gtpu_forwarded_log', 'gtpu_log_freq',
                   'half_close_timeout', 'half_open_timeout', 'handover_group',
                   'handover_group6', 'ie_allow_list_v0v1', 'ie_allow_list_v2',
                   'ie_remove_policy', 'ie_remover', 'ie_validation',
                   'ie_white_list_v0v1', 'ie_white_list_v2', 'imsi',
                   'imsi_filter', 'interface_notify', 'invalid_reserved_field',
                   'invalid_sgsns_to_log', 'invalid_sgsns6_to_log', 'ip_filter',
