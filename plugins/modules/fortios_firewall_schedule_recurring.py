...
def firewall_schedule_recurring(data, fos, check_mode=False):
    ...
    firewall_schedule_recurring_data = flatten_multilists_attributes(firewall_schedule_recurring_data)
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["firewall_schedule_recurring"]['options'][attribute_name] = module_spec['options'][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["firewall_schedule_recurring"]['options'][attribute_name]['required'] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "firewall_schedule_recurring")

        is_error, has_changed, result = fortios_firewall_schedule(module.params, fos, module.check_mode)
