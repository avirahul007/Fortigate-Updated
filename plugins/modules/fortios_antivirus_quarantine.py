...
def filter_antivirus_quarantine_data(json):
    option_list = ['agelimit', 'destination', 'drop_blocked',
                   'drop_heuristic', 'drop_infected', 'drop_intercepted',
                   'lowspace', 'maxfilesize', 'quarantine_quota',
                   'store_blocked', 'store_heuristic', 'store_infected',
                   'store_intercepted']
    dictionary = {}
...
def flatten_multilists_attributes(data):
    multilist_attrs = [[u'store_intercepted'], [u'drop_infected'], [u'drop_heuristic'], [u'store_heuristic'], [u'store_infected'], [u'store_blocked'],
                       [u'drop_intercepted'], [u'drop_blocked']]
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["antivirus_quarantine"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "antivirus_quarantine")
