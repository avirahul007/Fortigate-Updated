...
def wireless_controller_ble_profile(data, fos, check_mode=False):
    ...
    wireless_controller_ble_profile_data = flatten_multilists_attributes(wireless_controller_ble_profile_data)
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["wireless_controller_ble_profile"]['options'][attribute_name] = module_spec['options'][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["wireless_controller_ble_profile"]['options'][attribute_name]['required'] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "wireless_controller_ble_profile")
