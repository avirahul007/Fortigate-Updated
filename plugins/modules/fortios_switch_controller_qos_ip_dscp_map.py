...
def flatten_multilists_attributes(data):
    multilist_attrs = [[u'map', u'diffserv'], [u'map', u'ip_precedence']]
...
def switch_controller_qos_ip_dscp_map(data, fos, check_mode=False):
    ...
    switch_controller_qos_ip_dscp_map_data = flatten_multilists_attributes(switch_controller_qos_ip_dscp_map_data)
...
def fortios_switch_controller_qos(data, fos, check_mode):
    ...
    if data['switch_controller_qos_ip_dscp_map']:
        ...
        fos._module.fail_json(msg='missing task body: %s' % ('switch_controller_qos_ip_dscp_map'))
    if check_mode:
        return resp
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["switch_controller_qos_ip_dscp_map"]['options'][attribute_name] = module_spec['options'][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["switch_controller_qos_ip_dscp_map"]['options'][attribute_name]['required'] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "switch_controller_qos_ip_dscp_map")

        is_error, has_changed, result = fortios_switch_controller_qos(module.params, fos, module.check_mode)
