...
def flatten_multilists_attributes(data):
    multilist_attrs = [[u'headers', u'protocol']]
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["web_proxy_profile"]['options'][attribute_name] = module_spec['options'][attribute_name]
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "web_proxy_profile")
