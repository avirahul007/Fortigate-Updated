...
def filter_user_radius_data(json):
    option_list = ['accounting_server', 'acct_all_servers', 'acct_interim_interval',
                   ...
                   'group_override_attr_type', 'h3c_compatibility', 'interface',
                   'interface_select_method', 'name', 'nas_ip',
                   ...
                   'switch_controller_acct_fast_framedip_detect', 'switch_controller_service_type', 'tertiary_secret',
                   'tertiary_server', 'timeout', 'use_management_vdom',
                   'username_case_sensitive']
    dictionary = {}
...
def flatten_multilists_attributes(data):
    multilist_attrs = [[u'switch_controller_service_type'], [u'rsso_log_flags']]
