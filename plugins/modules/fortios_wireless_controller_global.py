...
def flatten_multilists_attributes(data):
    multilist_attrs = [[u'control_message_offload']]
...
def main():
    ...
    for attribute_name in module_spec['options']:
        fields["wireless_controller_global"]['options'][attribute_name] = module_spec['options'][attribute_name]
        if mkeyname and mkeyname == attribute_name:
            fields["wireless_controller_global"]['options'][attribute_name]['required'] = True
    ...
    if module._socket_path:
        ...
        versions_check_result = check_schema_versioning(fos, versioned_schema, "wireless_controller_global")
