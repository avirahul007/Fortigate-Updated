...
def filter_wireless_controller_vap_data(json):
    option_list = ['access_control_list', 'acct_interim_interval', 'additional_akms',
                   'address_group', 'alias', 'atf_weight',
                   'auth', 'broadcast_ssid', 'broadcast_suppression',
                   'bss_color_partial', 'bstm_disassociation_imminent', 'bstm_load_balancing_disassoc_timer',
                   'bstm_rssi_disassoc_timer', 'captive_portal_ac_name', 'captive_portal_auth_timeout',
                   'captive_portal_macauth_radius_secret', 'captive_portal_macauth_radius_server', 'captive_portal_radius_secret',
                   'captive_portal_radius_server', 'captive_portal_session_timeout_interval', 'dhcp_address_enforcement',
                   'dhcp_lease_time', 'dhcp_option43_insertion', 'dhcp_option82_circuit_id_insertion',
                   ...
                   'external_web', 'external_web_format', 'fast_bss_transition',
                   'fast_roaming', 'ft_mobility_domain', 'ft_over_ds',
                   'ft_r0_key_lifetime', 'gas_comeback_delay', 'gas_fragmentation_limit',
                   'gtk_rekey', 'gtk_rekey_intv', 'high_efficiency',
                   'hotspot20_profile', 'igmp_snooping', 'intra_vap_privacy',
                   'ip', 'ipv6_rules', 'key',
                   'keyindex', 'ldpc', 'local_authentication',
                   'local_bridging', 'local_lan', 'local_standalone',
                   'local_standalone_nat', 'mac_auth_bypass', 'mac_called_station_delimiter',
                   'mac_calling_station_delimiter', 'mac_case', 'mac_filter',
                   'mac_filter_list', 'mac_filter_policy_other', 'mac_password_delimiter',
                   'mac_username_delimiter', 'max_clients', 'max_clients_ap',
                   'mbo', 'mbo_cell_data_conn_pref', 'me_disable_thresh',
                   'mesh_backhaul', 'mpsk', 'mpsk_concurrent_clients',
                   'mpsk_key', 'mpsk_profile', 'mu_mimo',
                   'multicast_enhance', 'multicast_rate', 'nac',
                   'nac_profile', 'name', 'neighbor_report_dual_band',
                   'okc', 'owe_groups', 'owe_transition',
                   'owe_transition_ssid', 'passphrase', 'pmf',
                   'pmf_assoc_comeback_timeout', 'pmf_sa_query_retry_timeout', 'port_macauth',
                   'port_macauth_reauth_timeout', 'port_macauth_timeout', 'portal_message_override_group',
                   'portal_message_overrides', 'portal_type', 'primary_wag_profile',
                   ...
                   'rates_11n_ss34', 'sae_groups', 'sae_password',
                   ...
                   'tunnel_fallback_interval', 'usergroup', 'utm_profile',
...
def flatten_multilists_attributes(data):
    multilist_attrs = [[u'rates_11ac_ss34'], [u'rates_11a'], [u'ipv6_rules'], [u'owe_groups'], [u'rates_11n_ss12'], [u'broadcast_suppression'],
                       [u'sae_groups'], [u'rates_11n_ss34'], [u'additional_akms'], [u'rates_11ac_ss12'], [u'rates_11bg']]
